...
void ut_scc_union_digraphs(void** state) {
	(void) state;
...
void ut_scc_digraph_transpose(void** state) {
	(void) state;
...
void ut_scc_adjacency_product(void** state) {
	(void) state;
...
int main(void) {
	const struct CMUnitTest test_operations[] = {
	    cmocka_unit_test(ut_scc_union_digraphs),
	    cmocka_unit_test(ut_scc_digraph_transpose),
	    cmocka_unit_test(ut_scc_adjacency_product),
	};
