...
void scc_ut_delete_loops(void** state)
{
	...
	const iscc_Dpid ref_tail_ptr[6] = { 0, 0, 0, 0, 0, 0 };
	assert_memory_equal(dg6.tail_ptr, ref_tail_ptr, 6 * sizeof(iscc_Dpid));
...
void scc_ut_digraph_difference(void** state)
{
	...
	const iscc_Dpid ref_tail_ptr[6] = { 0, 0, 0, 0, 0, 0 };
	assert_memory_equal(minuend_dg8.tail_ptr, ref_tail_ptr, 6 * sizeof(iscc_Dpid));
	...
	const iscc_Dpid ref_tail_ptr13[6] = { 0, 0, 0, 0, 0, 0 };
	assert_memory_equal(minuend_dg13.tail_ptr, ref_tail_ptr13, 6 * sizeof(iscc_Dpid));
	...
	const iscc_Dpid ref_tail_ptr14[6] = { 0, 0, 0, 0, 0, 0 };
	assert_memory_equal(minuend_dg14.tail_ptr, ref_tail_ptr14, 6 * sizeof(iscc_Dpid));
