...
OBJECTS=data_obj.c digraph_core.o digraph_operations.o dist_search.o error.o greedy_clustering.o nng_clustering.o nng_core.o nng_findseeds.o scclust.o
BUILDDIR=build
DEBUGDIR=dbg
